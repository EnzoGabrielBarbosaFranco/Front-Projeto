<template>
	<q-form class="product-form" @submit="editarProduto">
		<q-input class="form-input" label="Nome" v-model="produto.nome" required></q-input>
		<q-input class="form-input" label="Descrição" v-model="produto.descricao" type="textarea" maxlength="200"
			required></q-input>
		<q-input class="form-input" label="Cor" v-model="produto.cor" required></q-input>
		<q-input class="form-input" label="Tamanho" v-model="produto.tamanho" required></q-input>
		<q-input class="form-input" label="Quantidade" v-model="produto.quantidade" type="number" min="1"
			required></q-input>
		<q-input class="form-input" label="Valor" v-model="produto.valor" type="number" min="1" step="0.01"
			required></q-input>
